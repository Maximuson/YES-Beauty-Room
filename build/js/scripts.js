...
var myScroll = new IScroll('.slider-wrapper', {
...
var LeftArrow = document.querySelector('.slider-button.left-arrow');
LeftArrow.addEventListener('click', function () {
  myScroll.prev();
});
var RightArrow = document.querySelector('.slider-button.right-arrow');
